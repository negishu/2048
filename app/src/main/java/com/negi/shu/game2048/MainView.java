...
public class MainView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    //Internal Constants
    static final int BASE_ANIMATION_TIME = 200000000;
    ...
    private void drawCellText(Canvas canvas, int value) {
        ...
        if (value == 2) {
            ...
            canvas.drawText("二", cellSize / 2, cellSize / 2 - textShiftY, paint);
        } else if (value == 4) {
            paint.setTextSize(textSize2);
            paint.setColor(getResources().getColor(R.color.text_black));
            canvas.drawText("四", cellSize / 2, cellSize / 2 - textShiftY, paint);
        } else if (value == 8) {
            paint.setTextSize(textSize2);
            paint.setColor(getResources().getColor(R.color.text_black));
            canvas.drawText("八", cellSize / 2, cellSize / 2 - textShiftY, paint);
        } else if (value == 16) {
            paint.setTextSize(textSize2);
            paint.setColor(getResources().getColor(R.color.text_white));
            canvas.drawText("十六", cellSize / 2, cellSize / 2 - textShiftY, paint);
        } else if (value == 32) {
            paint.setTextSize(textSize);
            paint.setColor(getResources().getColor(R.color.text_white));
            canvas.drawText("三十二", cellSize / 2, cellSize / 2 - textShiftY, paint);
        } else if (value == 64) {
            paint.setTextSize(textSize);
            paint.setColor(getResources().getColor(R.color.text_white));
            canvas.drawText("六十四", cellSize / 2, cellSize / 2 - textShiftY, paint);
        } else if (value == 128) {
            paint.setTextSize(textSize);
            paint.setColor(getResources().getColor(R.color.text_white));
            canvas.drawText("百二十八", cellSize / 2, cellSize / 2 - textShiftY, paint);
        } else if (value == 256) {
            paint.setTextSize(textSize);
            paint.setColor(getResources().getColor(R.color.text_black));
            canvas.drawText("二百五十六", cellSize / 2, cellSize / 2 - textShiftY, paint);
        } else if (value == 512) {
            paint.setTextSize(textSize);
            paint.setColor(getResources().getColor(R.color.text_black));
            canvas.drawText("五百十二", cellSize / 2, cellSize / 2 - textShiftY, paint);
        } else if (value == 1024) {
            paint.setTextSize(textSize);
            paint.setColor(getResources().getColor(R.color.text_black));
            canvas.drawText("千二十四", cellSize / 2, cellSize / 2 - textShiftY, paint);
        } else if (value == 2048) {
            paint.setTextSize(textSize);
            paint.setColor(getResources().getColor(R.color.text_white));
            canvas.drawText("二千四十八", cellSize / 2, cellSize / 2 - textShiftY, paint);
        } else {
    ...
    private void drawScoreText(Canvas canvas) {
        ...
        int textWidthHighScore = Math.max(titleWidthHighScore, bodyWidthHighScore) + textPaddingSize * 4;
        int textWidthScore = Math.max(titleWidthScore, bodyWidthScore) + textPaddingSize * 4;
    ...
    private void getLayout(int width, int height) {
        ...
        textSize = cellSize * cellSize / Math.max(cellSize, paint.measureText("0０００００"));
        textSize2 = cellSize * cellSize / Math.max(cellSize, paint.measureText("0００００"));
        ...
        bodyTextSize = (int) (textSize * 2);
        headerTextSize = textSize * 2;
        textPaddingSize = (int) (textSize / 2);
        iconPaddingSize = (int) (textSize / 2);
        ...
        sXNewGame = (endingX - iconSize) - iconPaddingSize;
        sXUndo = (startingX + iconPaddingSize);
        sYIcons = (endingY) + (iconSize / 2);
